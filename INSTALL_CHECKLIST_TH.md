# เช็กลิสต์ติดตั้ง MTS Result v2.1.0
...
3. เลือกเครื่อง แล้วสแกน QR พนักงาน
4. ทดสอบ Order/Tag เขียว/Tag เหลือง เลือกตารางกะ เริ่มผลิต สแกน WIP/FG Tag หยุดเครื่อง และปิดกะ
...
5. Export Excel และตรวจชีต Dashboard, Daily, Losses, Events, Approvals และ Attendance
